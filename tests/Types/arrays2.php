...
// the bool key initialiers are implicitly converted to int
  ...
  public array<bool, void> $pr_bool_void = array();
...
// the int key initialiers are used as is
  ...
  public array<int, void> $pr_int_void = array();
...
// the float key initialiers are implicitly converted to int
  ...
  public array<float, void> $pr_float_void = array();
...
// the num key initialiers are implicitly converted to int
  ...
  public array<num, void> $pr_num_void = array();
...
// the string key initialiers are used as is
  ...
  public array<string, void> $pr_string_void = array();

// there is no synax for writing a void expression for any key, so can use only an empty array

  public array<void, bool> $pr_void_bool = array();
  public array<void, int> $pr_void_int = array();
  public array<void, float> $pr_void_float = array();
  public array<void, num> $pr_void_num = array();
  public array<void, string> $pr_void_string = array();
  public array<void, void> $pr_void_void = array();
...
//  public array<array<bool>, string> $pr_arraybool_string = array(array(true) => "abc", array(false) => "def");
  ...
  public array<array<bool>, void> $pr_arraybool_void = array();
...
//  public array<C1, string> $pr_C1_string = array(x => 'ccc', x => 'aaa');
  ...
  public array<C1, void> $pr_C1_void = array();
