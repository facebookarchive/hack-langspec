...
in [§§](14-classes.md#constants); *function-deﬁnition* is defined in [§§](13-functions.md#function-definitions); *class-declaration*
...
*statement* is defined in [§§](#general) and *expresion* is defined in [§§](10-expressions.md#general-6).
...
[`eval` ([§§](10-expressions.md#eval))](http://www.php.net/manual/en/function.eval.php). 
