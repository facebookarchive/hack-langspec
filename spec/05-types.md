...
is defined in [§§](14-generic-types-methods-and-functions.md#type-parameters); *generic-type-argument-list* is defined in [§§](14-generic-types-methods-and-functions.md#type-arguments); and *name* and 
*qualified-name* are defined in [§§](09-lexical-structure.md#names).
