...
-   For a variable declared `global` in that function, `unset` removes the
    ...
    [`$GLOBALS`](http://us3.php.net/manual/en/reserved.variables.globals.php) array entry ([§§](07-variables.md#predefined-variables)).)
...
*postﬁx-expression* is defined in [§§](#general-3); and *expression* is defined
in [§§](#general-6).
...
*postﬁx-expression* is defined in [§§](#general-3); and *assignmment-expression*
...
*postﬁx-expression* is defined in [§§](#general-3); *name* is defined in
...
is treated as a dynamic property ([§§](14-classes.md#dynamic-members)). If *postﬁx-expression*'s class
